...
/**
 * Generated by `tspack migrate` from pnpm workspace compatibility metadata.
 * Package roots and identities are high-confidence inferred facts.
 * Review package-local MIGRATION_TODO_* comments before promotion.
 */
