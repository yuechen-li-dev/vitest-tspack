...
### F-045 — parallel Vitest targets contended for one configured API port
...
Classification: InteropRequirement and MigrationUX

M80h status: Resolved and remotely requalified.
