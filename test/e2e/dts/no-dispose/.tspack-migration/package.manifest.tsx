...
/**
 * Generated migration draft for test/e2e/dts/no-dispose/package.json.
...
export default definePackage(
  <Package
    name="@vitest/test-integration-dts-exact-optional-property--tspack-test-e2e-dts-no-dispose"
