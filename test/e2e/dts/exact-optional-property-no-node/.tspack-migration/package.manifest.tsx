...
/**
 * Generated migration draft for test/e2e/dts/exact-optional-property-no-node/package.json.
...
export default definePackage(
  <Package
    name="@vitest/test-integration-dts-exact-optional-property--tspack-test-e2e-dts-exact-optional-property-no-node"
    version="0.0.0"
    kind="app"
